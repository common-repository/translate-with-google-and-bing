<?php
/*
 Plugin Name: Translate with Google and Bing
 Plugin URI: /
...
function translate-with-google-and-bing_plugin_empty() {
	?>
	<div class="error">
		<h3><?php printf( 'Warning: The plugin has been removed from your site.', 'translate-with-google-and-bing' ); ?></h3>
...
add_action( 'admin_notices', 'translate-with-google-and-bing_plugin_empty' );
